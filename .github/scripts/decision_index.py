...
_ASSIGNMENTS: dict[str, list[int | tuple[int, int]]] = {
    ...
    "02": [(8, 15), 20, (22, 40), 74, 119, 136, 141],
    # メトリクス、ベンチマーク、メモリ、プロファイリング、回帰検知
    "03": [
        16, 19, 21, (41, 49), (56, 58),
        79, 80, 81, 82, (84, 90), (92, 97), 99, 101, (104, 106), (109, 115), 117, 118,
        120, 121, 122, 123, 124, 125, 127, 129, 130, 132, 135, 137, 138, 142, 143, 144,
        145, 147, 148, 149, 150, 151, 152,
    ],
    # コンテンツブロック、DevTools、ダウンロード、権限、サイトデータ、検索
    "04": [17, 18, (59, 60), 64, 66, 69, 71, 72, (75, 78), 139, 140],
    # Windows、アイコン、CI、リリース、マルチウィンドウ
    "05": [(50, 55), 68, 70, 73, 83, 91, 98, 100, 103, 107, 108, 126, 128, 131, 133, 134, 153],
    # 入力値堅牢性、依存監査、セッション復元、設定
    "06": [61, 62, 63, 65, 67, 102, 116, 146],
}
