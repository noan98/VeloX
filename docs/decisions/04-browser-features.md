...
主担当は **D17–D18, D59–D60, D64, D66, D69, D71–D72, D75–D78, D139–D140** の 15 件 (網羅的な一覧は下の「詳細」節。ここは読み進める手がかりとしての要約)。
...
**このカテゴリが主担当の Decision: D17–D18, D59–D60, D64, D66, D69, D71–D72, D75–D78, D139–D140** (15 件)
...
- [D140](./archive.md#d140-ダウンロードの-success-を鵜呑みにしない-issue-128--1-件失敗するとセッションの以後全部が失敗扱いになるのを実測で確認した) — ダウンロードの `success` を鵜呑みにしない (Issue #128) — 1 件失敗するとセッションの以後全部が失敗扱いになるのを実測で確認した
