...
| --- | --- | ---: | ---: | ---: |
| `minimal.html` | **`suspended_tab_count`** | **12** | **16** | **+4 (+35%)** |
...
| `dom_heavy.html` | **`suspended_tab_count`** | **16** | **17** | **+1 (+6%)** |
...
休止タブ数の減少は `minimal.html` で **4 タブ**、`dom_heavy.html` で
**1 タブ**。**予算を 323 MiB 増やして買えるものが、重いページでは 1/4 に
なる。**
